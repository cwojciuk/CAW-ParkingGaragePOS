 ...
 */
public class FeeDefaultCalculator implements FeeParkedCarCalculatorStrategy{
    ...
    private double minimumFee = 1.00;
    private double minimumFeeHours = 1;
    private double chargePerAdditionalTime = 1.00;
